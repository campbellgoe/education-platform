...
export default function RegisterDefault() {
    return <Suspense fallback={<p>Loading...</p>}><Register /></Suspense>;
}
function Register() {
    ...
    const fields = {
        ...
        password: register('password', {
            ...
            minLength: { value: MIN_PASSWORD_LENGTH, message: MIN_PASSWORD_MESSAGE }
        })
    }
        ...
        <div className="card">
            ...
            <div className="card-body">
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <Link href="/app/account/login" className="btn btn-link">Cancel</Link>
                </form>
            </div>
        </div>
    );
